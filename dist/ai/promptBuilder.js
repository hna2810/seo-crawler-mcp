...
exports.aggregateContentStats = aggregateContentStats;
exports.buildSEOExpertPrompt = buildSEOExpertPrompt;
function aggregateContentStats(session, contentRatio, classifications) {
    ...
    const subtopicArticlesMap = new Map();
...
function buildSEOExpertPrompt(session, _audit, _structure, contentRatio, classifications) {
