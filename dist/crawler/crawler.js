...
class WebsiteCrawler {
    ...
    constructor(options) {
        ...
        const httpsAgent = new https_1.default.Agent({ keepAlive: true, maxSockets: 60 });
        const httpAgent = new http_1.default.Agent({ keepAlive: true, maxSockets: 60 });
    ...
    async crawlSinglePage(targetUrl, depth, startMs, notifyProgress) {
        ...
        try {
            ...
            const pageData = (0, extractor_1.extractPageData)(typeof res.data === "string" ? res.data : "", targetUrl, finalUrl, effectiveStatusCode, contentType, crawlTimeMs, depth, this.rootDomain);
            if (isSoft404) {
                ...
                if (titleLower.includes("404 not found") ||
            ...
            if (depth < this.options.maxDepth && this.options.mode !== "sitemap") {
                const candidateLinks = pageData.discoveryLinks && pageData.discoveryLinks.length > 0
