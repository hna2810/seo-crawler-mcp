...
exports.filterAndRankKeywords = filterAndRankKeywords;
exports.runKeywordResearch = runKeywordResearch;
 ...
 */
async function generateSeedKeywords(userIdeas, contentGaps, llmConfig) {
...
Trả về DUY NHẤT danh sách từ khóa, mỗi từ một dòng, không đánh số thứ tự, không kèm giải thích hay văn bản khác.`;
            const aiReply = await (0, llmService_1.streamLLMAnalysis)(llmConfig, systemPrompt, userPrompt, () => { });
...
function filterAndRankKeywords(rawKeywords, contentGaps, maxKeywords = 200) {
    ...
    for (const raw of rawKeywords) {
        ...
        // Map competition
        let competitionText = "Trung bình";
 ...
 */
async function runKeywordResearch(request) {
